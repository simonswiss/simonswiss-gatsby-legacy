...
path: 'test-post'
postdate: '2020-04-27'
intro: 'This is the intro text. Make it pop!'
---

import { Link } from 'gatsby';
import IntroText from 'components/intro-text';
import { CodeBlock, Image, Tweet, PullQuote } from 'components/long-form';
...
<PullQuote author="Simon">
  This is really cool, but I honeslty don't think I want to do this again.
  Seriously.
</PullQuote>
...
<Link to="/talks/real-life-journey-utility-first-css">My talk</Link> was scheduled
