---
title: 'People do not like change'
path: 'utility-first-css/01-people-do-not-like-change'
postdate: '2019-05-05'
intro:
...
The web is relatively young. Our industry is still trying to figure out the best way to build websites and web applications. We are on a constant quest to improve consistency, maintenance a scale, page loading speed...

Here's an interesting exercise: let's compare our industry to an classic Olympic discipline: _high jump_.
...
<Link to="/talks/real-life-journey-utility-first-css">My talk</Link> was scheduled to close day 1 of the conference. Sort of a mini keynote! :) It went extremely well and the discussions it sparked showed my presentation definitely hit a nerve.
